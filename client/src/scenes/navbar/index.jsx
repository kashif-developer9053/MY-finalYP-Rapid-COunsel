  ...
  return (
    <FlexBetween padding="1rem 6%" backgroundColor={theme.palette.background.alt}>
      <FlexBetween gap="1.75rem">
        ...
        >
 <div className="logo-container" style={{ backgroundColor: 'whitesmoke' , width:'200px', borderRadius:'20px' ,padding:'5px' }}>
      ...
      {!isNonMobileScreens && isMobileMenuToggled && (
        ...
        >
          ...
          >
            ...
            <motion.a whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.9 }}>
              <IconButton>
                <Notifications sx={{ color: "#FF80FF" }} />
                <Typography sx={{ color: "#28188f" }}>Notifications</Typography>
              </IconButton>
            </motion.a>
            ...
            <motion.a whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.9 }}>
              <IconButton>
                ...
                <Typography sx={{ color: "grey" }}>Help</Typography>
              </IconButton>
            </motion.a>
